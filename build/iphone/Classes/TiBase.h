...
// in simulator we redefine to format for meigenapp Developer console
...
{\
	NSString * exceptionName = [@"org.meigenapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.meigenapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImeigenappNativeItemNone = -1, 
	UImeigenappNativeItemSpinner = -2,
	UImeigenappNativeItemProgressBar = -3,
	
	UImeigenappNativeItemSlider = -4,
	UImeigenappNativeItemSwitch = -5,
	UImeigenappNativeItemMultiButton = -6,
	UImeigenappNativeItemSegmented = -7,
	
	UImeigenappNativeItemTextView = -8,
	UImeigenappNativeItemTextField = -9,
	UImeigenappNativeItemSearchBar = -10,
	
	UImeigenappNativeItemPicker = -11,
	UImeigenappNativeItemDatePicker = -12,
	
	UImeigenappNativeItemInfoLight = -13,
	UImeigenappNativeItemInfoDark = -14,
	
	UImeigenappNativeItemDisclosure = -15,
	
	UImeigenappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all meigenapp instances of
