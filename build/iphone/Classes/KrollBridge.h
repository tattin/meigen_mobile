...
@interface meigenappObject : KrollCoverageObject {
#else
@interface meigenappObject : KrollObject {
#endif
@private
...
extern NSString * meigenapp$ModuleRequireFormat;
