...
/**
 Base class for all meigenapp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the meigenapp view hierarchy (such as wrapped iOS UIViews) was touched.
