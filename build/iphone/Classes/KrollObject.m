...
//@interface meigenappObject : NSObject
//@end

@interface meigenappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[meigenappObject class]])
		{
			for (NSString *key in [[(meigenappObject*)o modules] allKeys])
			{
