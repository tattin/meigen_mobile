...
/**
 The base class for all meigenapp modules
 */
...
/**
 meigenapp Platform calls this method on startup.
 */
-(void)startup;

/**
 meigenapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 meigenapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 meigenapp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 meigenapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
